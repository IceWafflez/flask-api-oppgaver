...
add_element(posts, {"User_id": "0", "Title": "test post", "Body": "ahhhhhhhhhhhhhhh"})
...
def create_user():
    ...
    print(content)
    if content["status"] not in ["inactive", "active"]:
        return {"message": "no bueno"}, 400
...
def create_post():
    ...
    print(content)
    # Returner den ny-opprettede brukeren, med statuskode 201 CREATED
    return wrap_data(created_post), 201